...
TRANSLATIONS = {
    ...
    'footer_text': {'tr': 'Gözenek ve Renk Tespit Yazılımı v1.0 — 2026  |  Murat SERT — AKÜ', 'en': 'Pore Segmentation Suite v1.0.0 — 2026  |  Murat SERT — Afyon Kocatepe University'},
    ...
    'cb_footer_default': {'tr': 'Generated by Gözenek ve Renk Tespit Yazılımı v1.0 (Sert et al. 2026)', 'en': 'Generated by Pore Segmentation Suite v1.0 (Sert et al. 2026)'},
